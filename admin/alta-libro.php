...
<html lang="es">
	...
	<body>
		...
		<div class="content">
			<div class="container">
				<h3>Alta libro</h3>
				<form action="alta-libro-post.php" method="post">
					<input class="full-width" type="text" name="isbn" placeholder="ISBN">
					<input class="full-width" type="text" name="autor" placeholder="Autor">
